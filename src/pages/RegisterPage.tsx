...
export function RegisterPage() {
  ...
  // Pre-llenar wallet desde Freighter si viene del flujo de connectWallet
  ...
  // Si connectedWallet cambia (raro pero posible), sincronizar
  useEffect(() => {
    if (connectedWallet && !walletAddress) setWalletAddress(connectedWallet);
  // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [connectedWallet]);

  // Ir al dashboard cuando el registro sea exitoso
  useEffect(() => {
  ...
  // Cargar wallet desde Freighter directamente en el form de registro
